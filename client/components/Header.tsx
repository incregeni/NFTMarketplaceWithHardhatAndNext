...
export const Header:NextPage = () => {
  return (
    <header className='py-[15px] px-[15px] bg-[#0b1426] text-white'>
      <nav className='grid grid-cols-3 items-center justify-center'>
        <div className='flex items-center justify-center'>
         <i>
          <svg width="208" height="28" viewBox="0 0 208 28" fill="none" className="w-[15em] h-[2em]">
         ...
         <div className='ml-2'>
           <input type='search' placeholder='Search collectibles and collections'/>
         </div>
        </div>
        <ul className='col-[3] flex items-center justify-around'>
          <li><a className='cursor-pointer'>Marketplace</a></li>
          <li><a className='bg-gradient-to-r from-[#1199fa] to-[#11d0fa] p-2 rounded-md cursor-pointer'>Create</a></li>
        </ul>
      </nav>
    </header>
  )
